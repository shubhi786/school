            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <div class="col-5-xxxl col-xl-5 col-lg-5 col-12 form-group text-right">
                                <a href="add-class.php" class="btn btn-primary btn-lg add-btn">+ Add New</a>
                            </div>
                            <div class="col-1-xxxl col-xl-1 col-lg-1 col-12 form-group  heading-layout1">
                           <div class="dropdown">
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                <div class="col-3-xxxl col-xl-3 col-lg-3 col-12 form-group">
                                    <input type="text" placeholder="Search by Teacher's ID ..." class="form-control">
                                </div>
                                <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
                                    <input type="text" placeholder="Search by Teacher Name ..." class="form-control">
                                </div>
                                <div class="col-4-xxxl col-xl-3 col-lg-3 col-12 form-group">
                                    <input type="text" placeholder="Search by Teacher's Phone ..." class="form-control">
                                </div>
                                    ...
                                    <tr>
                                        <th> 
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label">Emp. Code</label>
                                            </div>
                                        </th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"><?php echo $rows['emp_code']; ?></label>
                                            </div>
                                        </td>
                                        ...
                                        <td><?php echo $rows['class_time']; ?></td>
                                        <td><?php echo $rows['class_date']; ?></td>
                                         <td>
                                            <div class="dropdown">
