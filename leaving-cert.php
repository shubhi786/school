                                ...
                                <div class="header-inline item-header">
                                    ...
                                    <div class="header-elements">
                                        <ul>
                                            ...
                                            <li><a href="generate-leaving-cert.php?session_name=<?php echo $rows['session_name']; ?>&s_name=<?php echo $rows['Student_Fname']; ?>&class=<?php echo $rows['Class']; ?>&rollno=<?php echo $rows['Roll_Number']; ?> "><i class="fas fa-download"></i>  Generate</a></li>
                                        </ul>
                                    </div>
                                </div>
