                ...
                <div class="card height-auto" id="Shadow">
                    <div class="card-body">
                        ...
                        <div class="search-box container mb-5">  
                            ...
                            <div class="row gutters-8">
                                <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
                                    <input type="text" placeholder="Search by User name ..." class="form-control" name="s_name"/>
                                </div>                            
                        ...
                        <?php
                            ...
                            if(isset($_SESSION['s_name']) ||  isset($_GET['uname']) )
                            {
                                
                                $q = "SELECT * FROM users WHERE uname='$get_uname' OR uname='$s_name' LIMIT 1";
                        ...
                        <div class="single-info-details mt-5">
                            ...
                            <div class="item-content">
                                <div class="header-inline item-header">
                                    <h3 class="text-dark-medium font-medium"><?php echo $rows['uname']; ?></h3>
                                ...
                                <div class="info-table table-responsive">
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <tr>
                                                <td>Name:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['uname']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Pass:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['pass']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Date Of Registration:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['date']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
