            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>Compose Message to Staff</li>
                    </ul>
                </div>
                                ...
                                <form class="new-added-form" method="post">
                                    <?php
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $q = "INSERT INTO messaging VALUES('0','$mail_subject','$mail_to','$mail_body','staff',now()) ";
                                            $run_this_query = $conn->query($q);
                                    ...
                                    <div class="row">
                                        <div class="col-12 form-group">
                                            <label>Title</label>
                                            <input type="text" placeholder="" class="form-control" name="mail_subject">
                                        </div>
                                        <div class="col-12 form-group">
                                            <label>Recipient</label>
                                            <input type="text" placeholder="" class="form-control" name="mail_to">
                                        </div>
                                        <div class="col-12 form-group">
                                            <label>Message</label>
                                            <textarea class="textarea form-control" id="form-message" cols="10"
                                            rows="9" name="mail_body"></textarea>
                                        </div>
