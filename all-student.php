            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto" id="Shadow">
                    <div class="card-body">
                        ...
                        <form class="mg-b-20" method="post"  name="form" id="form" enctype="multipart/form-data">
                               ...
                               <thead>
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="student_update.php?rollno=<?php echo $rows['Roll_Number']; ?>&session_name=<?php echo $rows['session_name']; ?>&class_name=<?php echo $rows['Class']; ?> "><i class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                    <a class="dropdown-item" href="student-details.php?rollno=<?php echo $rows['Roll_Number']; ?>&admission_no=<?php echo $rows['Admission_No'] ?>"><i class="fas fa-redo-alt text-orange-peel"></i>View</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=''>
                                                ...
                                                <label class=''><?php echo $rows['Roll_Number']; ?></label>
                                            </div>
                                        </td>

                                        <td>
                                            <?php echo $rows['Admission_No']; ?>
                                        </td>
                                        ...
                                        <td>
                                            <?php echo $rows['Student_Fname'];?> <?php echo $rows['Student_Lname'];?>
                                        </td>
