                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                       ...
                       <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                ...
                                <li class="nav-item">
                                    <a href=".php" class="nav-link"><i class="fas fa-angle-right"></i>Income</a>
                                </li>
                            </ul>
                        </li>
                        </li>
                ...
                <div class="info_pallete">
                    <div class="parent">
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <h1><?php if($_SESSION['uname']) {echo $_SESSION['uname'];} else { echo "<script>location.href='login.php'</script>"; } ?></h1>
                                </td>
                            </tr>
                        </table>
                    </div>
