        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Date Wise Fees Report</h3>
                    <ul>
                        <li>
                            <a href="index.php">Home</a>
                        </li>
                        <li>Date Wise Fees Reports</li>
                    </ul>
                </div>
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="col-xl-4 col-lg-4 col-12">
                                <input type="submit" name="get_val"class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" value="Select Date">
                            </div>
                            </div>
                        </form>
                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <?php
                                        ...
                                        { 
                                            ...
                                            // $find_date = date_format(new DateTime($date1),"Y-d-m");
                                            $myDateTime = DateTime::createFromFormat('d/m/Y', $date);
                                            $find_date = $myDateTime->format('Y-m-d');
                                            // echo $find_date;
                                        } 
                                        else 
                                        { 
                                            $find_date = '9999999';
                                            echo "<h6 style='color:red;'>Nothing to show yet...Please search for a Date</h6>";
                                        }

                                        $q = "SELECT * FROM fees WHERE date_of_deposit LIKE '%$find_date%' ";
                                        ...
                                        <td><?php echo $rows['date_of_deposit']; ?></td>
                                         <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#"><i class="fas fa-times text-orange-red"></i>Close</a>
                                                    <a class="dropdown-item" href="update_fees.php?r_no=<?php echo $rows['receipt_no']; ?>&student_class=<?php echo $rows['class']; ?>&student_rollno=<?php echo $rows['student_roll_no']; ?>&session_name=<?php echo $rows['session_name']; ?>&class_section=<?php echo $rows['class_section']; ?>&admission_code=<?php echo $rows['admission_code']; ?>"><i class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
