                ...
                <div class="card height-auto mb-5">
                    <div class="card-body">
                        ...
                        <div class="col-5-xxxl col-xl-5 col-lg-5 col-12 form-group text-right">
                                <a href="add-staff.php" class="btn btn-primary btn-lg add-btn">+ Add New</a>
                            </div>
                                         ...
                                         <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#"><i class="fas fa-times text-orange-red"></i>Close</a>
                                                    <a class="dropdown-item" href="#"><i class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                    <a class="dropdown-item" href="staff-details.php?code=<?php echo $rows['code']; ?>"><i class="fas fa-redo-alt text-orange-peel"></i>View</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>  
