                    ...
                    <div class="card-body">
                        ...
                        <div class="search-box container mb-5">  
                            ...
                            <?php
                                ...
                                $_SESSION['staff_code_get'] = $_GET['code'];

                                if(isset($_POST['get_val']))
                                {
                                   
                                    $_SESSION['staff_code'] = $_POST['staff_code'];
                            ...
                            <div class="row gutters-8">
                                <div class="col-3-xxxl col-xl-3 col-lg-3 col-12 form-group">
                                    <input type="text" placeholder="Search by Code ..." class="form-control" name="staff_code"/>
                                </div>
                                <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
                                    <input type="text" placeholder="Search by Name ..." class="form-control" name="staff_name"/>
                                </div>                            
                        ...
                        <?php
                            ...
                            $staff_code_get = $_SESSION['staff_code_get'];
                            $staff_code = $_SESSION['staff_code'];
                            $staff_name = $_SESSION['staff_name'];

                            if(isset($_SESSION['staff_code_get']) || isset($_SESSION['staff_name']) || isset($_SESSION['staff_post']) )
                            {
                                
                                $q = "SELECT * FROM staff WHERE code='$staff_code_get' OR code='$staff_code' OR first_name='$staff_name' LIMIT 1 ";
