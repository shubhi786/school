                    ...
                    <div class="card-body">
                        ...
                        <div class="search-box container mb-5">  
                            ...
                            <?php
                                ...
                                $_SESSION['teacher_code_get'] = $_GET['emp_code'];

                                if(isset($_POST['get_val']))
                                {
                                   
                                    $_SESSION['teacher_code'] = $_POST['teacher_code'];
                                    $_SESSION['teacher_phone'] = $_POST['teacher_phone'];

                                }
                             ?>
                            <div class="row gutters-8">
                                <div class="col-3-xxxl col-xl-3 col-lg-3 col-12 form-group">
                                    <input type="text" placeholder="Search by Code ..." class="form-control" name="teacher_code"/>
                                </div>
                                <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
                                    <input type="text" placeholder="Search by Phone ..." class="form-control" name="teacher_phone"/>
                                </div>                            
                        ...
                        <?php
                            ...
                            $teacher_code_get = $_SESSION['teacher_code_get'];
                            $teacher_code = $_SESSION['teacher_code'];
                            $teacher_phone = $_SESSION['teacher_phone'];

                            if(isset($_SESSION['teacher_code_get']) || isset($_SESSION['teacher_phone']) || isset($_SESSION['teacher_code']) )
                            {
                                
                                $q = "SELECT * FROM staff WHERE code='$teacher_code_get' OR code='$teacher_code' OR Phone='$teacher_phone' LIMIT 1 ";
                        ...
                        <div class="single-info-details mt-5">
                            <div class="item-img">
                                <img src="<?php echo $rows['Photo']; ?>" alt="student" style="height: 170px; width: 150px; margin-top: 10px;">
                            </div>
                            <div class="item-content">
                                <div class="header-inline item-header">
                                    <h3 class="text-dark-medium font-medium"><?php echo $rows['first_name']; ?></h3>
                                ...
                                <div class="info-table table-responsive">
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <tr>
                                                <td>Name:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['first_name']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Employee Code:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['code']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Gender:</td>
                                            ...
                                            <tr>
                                                <td>Father Name:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['fname']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Mother Name:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['mname']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Date Of Birth:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['Date Of Birth']; ?></td>
                                            </tr>
                                            <tr>
                                            <td>E-mail:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['E-Mail']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Phone:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['Phone']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Religion:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium"><?php echo $rows['Marital Status']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Category:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium"><?php echo $rows['Employee Status']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Employee Status:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['Employee Status']; ?></td>
                                            ...
                                            <tr>
                                                <td>Aadhaar No:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['Aadhaar No']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>PAN No:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['Pan No']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Blood Group:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['Blood Group']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
