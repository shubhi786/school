                    ...
                    <div class="card-body">
                        ...
                        <?php
                                ...
                                if(isset($_POST['get_val']))
                                {
                                    ...
                                    $_SESSION['parent_phone'] = $_POST['parent_phone'];
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <?php
                                    ...
                                    // if(isset($_SESSION['parent_id']) || isset($_SESSION['parent_name']) || isset($_SESSION['parent_phone']))
                                    // {
                                        // $q = "SELECT * FROM parents WHERE id='$parent_id' OR F_Name='$parent_name' OR M_Name='$parent_name' OR F_Phone='$parent_phone' OR M_Phone='$parent_phone' ";
                                    // }
                                    // else
                                    // {
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"><?php echo $rows['F_Name']; ?></label>
                                            </div>
                                        </td>                                        
                                        <td><?php echo $rows['F_Phone']; ?></td>
                                        <td><?php echo $rows['F_Occupation']; ?></td>
                                        <td class="text-center"><img src="<?php echo $rows['F_Photo']; ?>" alt="father's pic" width="70px" height="70px"></td>
                                        <td><?php echo $rows['M_Name']; ?></td>
                                        <td><?php echo $rows['M_Phone']; ?></td>
                                        <td><?php echo $rows['M_Occupation']; ?></td>
                                        <td class="text-center"><img src="<?php echo $rows['M_Photo']; ?>" alt="father's pic" width="70px" height="70px"></td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <?php echo " <a class='dropdown-item' href='parent_update.php'><i class='fas fa-cogs text-dark-pastel-green'></i>Edit</a> ";  ?>
