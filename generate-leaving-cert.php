...
<body>
    ...
    <button id="print_now" style="width:100px;height:50px;">Print Now</button>
    ...
    <section class="p-5" id="print_area" style="padding:20px;">
        <div class="canvas p-3" style="outline:2px solid black;font-family:algerian;text-transform:uppercase;padding:15px;">
            ...
            <div class="student_info p-5 text-center" style="text-align:center">
                ...
                <span class="" style="font-size:25px;"><?php echo $rows['Date_of_birth']; ?></span>. <br/> Entered school and was enrolled on <span class="" style="font-size:25px;"><?php echo $rows['Admission_Date']; ?></span> in standard <span class="" style="font-size:25px;"><?php echo $rows['Class']; ?></span> and left on <span class="" ><form action=""><input  value="<?php echo date('d-m-Y'); ?>" style="font-size:25px;width:150px;border:none;border-bottom:1px solid #000;outline:none;height:20px;" type="text"></span>
                at standard <span class=""><input value="<?php echo $rows['Class']; ?>" style="font-size:25px;font-size:25px;width:150px;border:none;border-bottom:1px solid #000;outline:none;height:20px;" type="text"></span>. <br/> Having satisfactorily completed the approved course for standard <span class=""><input value="<?php echo $rows['Class']; ?>" style="font-size:25px;font-size:25px;width:150px;border:none;border-bottom:1px solid #000;outline:none;height:20px;" type="text"></form></span>
