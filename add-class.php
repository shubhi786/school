                    ...
                    <div class="card-body">
                        ...
                        <?php
                                ...
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    $q = "INSERT INTO class_schedule VALUES('0','$teacher_name','$emp_code','$gender','$class_name','$subject','$section','$class_time','$class_date','$phone','$email',now() ) ";
                                    $run = $conn->query($q);
...
Toast.fire({
  ...
  title: 'Something went wrong'
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Section *</label>
                                    <select class="select2" class="section" name="section">
                                        <option value="">Please Select *</option>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Time *</label>
                                    <input type="text" placeholder="" class="form-control" name="class_time">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Date*</label>
                                    <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker" data-position="bottom right" name="class_date">
