                        ...
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    $q = "INSERT INTO exam VALUES('0','$exam_code','$exam_name','$subject_name','$subject_type','$exam_class','$exam_section','$exam_time','$exam_duration','$exam_date','$session_name',now() ) ";
                                    $run = $conn->query($q);
                             ...
                             ?>
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            ...
                                            <input type="text" placeholder="" class="form-control" name="exam_name">
                                        </div>
                                    ...
                                    <select class="select2" name="subject_name">
                                    <?php
                                        include('php/dbconfig.php');
                                    ...
                                    if($sql->num_rows > 0)
                                    {
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            ...
                                            <select class="select2" name="exam_class" value="" id="checkVal">
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            ...
                                            <select class="select2" name="exam_section">
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>Exam Start Time (in 24 Hours Format)</label>
                                            <input type="text" placeholder="" class="form-control" name="exam_time">
                                            <i class="far fa-clock"></i>
                                        </div>

                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>Exam End Time (in 24 Hours Format)</label>
                                            <input type="text" placeholder="" class="form-control" name="exam_duration">
                                            <i class="far fa-clock"></i>
                                        </div>
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>Select Date</label>
                                            <input type="text" placeholder="dd/mm/yyyy"
                                                class="form-control air-datepicker" name="exam_date">
                                    ...
                                    if($sql->num_rows > 0)
                                    {
                                        ...
                                        {?>
                                            <tr>
                                                ...
                                                <td><?php echo $rows['exam_start_time']; ?></td>
                                                <td><?php echo $rows['exam_end_time']; ?></td>
