                    ...
                    <form class="new-added-form" method="post">
                        <?php
                                ...
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    $q = "INSERT INTO session_master VALUES('0','$session_name' ) ";
                                    $run = $conn->query($q);
...
Toast.fire({
  ...
  title: 'Something went wrong'
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" name="session_start_date">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" name="session_end_date">
                                        <option value="2022">2022</option>
                                        <option value="2023">2023</option>
                                        <option value="2024">2024</option>
                                        <option value="2025">2025</option>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" name="session_status">
                        ...
                        <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $rows['session_start_date']; ?></td>
                                        <td><?php echo $rows['session_end_date']; ?></td>
                                        <td><?php echo $rows['session_status']; ?></td>
                                    </tr>  
                                    <?php
                                        }
                                    } 
