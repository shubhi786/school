                    ...
                    <form class="new-added-form" method="post">
                        <?php
                                ...
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    $fee_head_name = $_POST['fee_head'];
                                    $head_charges = $_POST['head_charges'];

                                    $check_for_same = "SELECT * FROM profiles_info WHERE fee_head='$fee_head_name' AND profile_name='$profile_name' ";
                                    $run_this_query = $conn->query($check_for_same);

                                    if($run_this_query->num_rows > 0)
                                    {?>
                                    <script>
...
Toast.fire({
  ...
  title: 'Fee head already exists...'
                                    ...
                                    {
                                        $q = "INSERT INTO profiles_info VALUES('0','$profile_name','$fee_head_name','$head_charges',now() ) ";
                                        $run = $conn->query($q);                                    
...
Toast.fire({
  ...
  title: 'Something went wrong'
                                ...
                                $get_profile_name = $_GET['profile_name'];

                                $q = "SELECT * FROM fee_profile WHERE profile_name='$get_profile_name' ";
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="profile_name" value="<?php echo $rows['profile_name']; ?>">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Fee head Name *</label>
                                    <select class="select2" name="fee_head" value="">
                                    <?php
                                        include('php/dbconfig.php');

                                        $q = "SELECT DISTINCT * FROM fee_head";
                                    ...
                                    if($sql->num_rows > 0)
                                    {
                                        while($rows = $sql->fetch_assoc())
                                        {?>
                                        <option value="<?php echo $rows['head_name']; ?>"><?php echo $rows['head_name']; ?></option>
                                        <?php }} ?>
                                    </select>
                                </div>

                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Head Charges</label>
                                    <input type="text" placeholder="" class="form-control" name="head_charges" value="">
                                </div>

                                <div class="col-md-6 form-group"></div>
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Save</button>
                                    <button class="btn-fill-lg bg-blue-dark btn-hover-yellow"><a class="text-white" href="fee-profile.php">Back</a></button>
                                    <button class="btn-fill-lg bg-blue-dark btn-hover-yellow"><a class="text-white" href="generate-fee.php">Generate Fee</a></button>
                                </div>
                            </div>
                            <?php }} ?>
                        </form>
                        ...
                        <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $q = "SELECT * FROM profiles_info WHERE profile_name='$get_profile_name' ";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $rows['fee_head']; ?></td>
                                        <td><?php echo $rows['head_charges']; ?></td>
                                        <td>
                                            <div class="dropdown">
