                        ...
                        <?php
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $session_name = $_POST['session_name'];
                                    ...
                                    $q = "SELECT SUM(head_charges) AS total_confirmed FROM profiles_info WHERE profile_name='$profile_name_get_fees' ";
                                    ...
                                    if($sql->num_rows > 0)
                                    {
                                        ...
                                        {
                                            $total_fees = $rows['total_confirmed'];
                                        }
                                    }                                    

                                    $head_name = 'tution fees';
                                    $check_monthly_fees = "SELECT * FROM profiles_info WHERE profile_name='$profile_name_get_fees' AND fee_head='tution fees' ";
                                    $run_it_now = $conn->query($check_monthly_fees);

                                    if($run_it_now->num_rows > 0)
                                    {
                                        while($rows2 = $run_it_now->fetch_assoc())
                                        {
                                            $monthly_fees = $rows2['head_charges'];
                                        }
                                    }


                                   
                                    $query = "INSERT INTO generated_fees VALUES('0','$profile_name_get_fees','$session_name','$class','$total_fees','$monthly_fees',now() ) ";
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <?php
                                        if(isset($_POST['get_fees']))
                                        {
                                            ...
                                            // echo "<script>alert('$profile_name_get_fees')</script>";
                                        }
                                     ?>
                                    <select class="select2" name="profile_name" value="">
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <?php
                                        ...
                                        $q = "SELECT DISTINCT student_class FROM generated_fees";
                                    ...
                                    <tr>
                                        <td>
                                        <label class="form-check-label"><?php echo $rows['student_class']; ?></label>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="view-generated-fees.php?student_class=<?php echo $rows['student_class']; ?>"><i class="fas fa-redo-alt text-orange-peel"></i>View</a>
                                                </div>
                                            </div>
                                        </td>   
                                    </tr>
