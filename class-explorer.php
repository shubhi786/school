                ...
                <div class="card height-auto">
                    ...
                    <form class="new-added-form" method="post">
                        <?php
                                ...
                                {
                                    $_SESSION['search_class'] = $_POST['class'];
                                    $_SESSION['search_section'] = $_POST['section'];
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <?php
                                        ...
                                        $q = "SELECT DISTINCT class_name FROM class";
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <?php
                                        ...
                                        // $search_class = $_SESSION['search_class'];

                                        $q = "SELECT DISTINCT section_name from sections ";
                                    ...
                                    if($sql->num_rows > 0)
                                    {
                                        while($rows = $sql->fetch_assoc())
                                        {?>
                                        <option value="<?php echo $rows['section_name']; ?>"><?php echo $rows['section_name']; ?></option>
                                        <?php }} ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Get Class</button>
                        ...
                        <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $search_class = $_SESSION['search_class'];
                                        $search_section = $_SESSION['search_section'];

                                        $q = "SELECT * FROM admission WHERE Class='$search_class' AND Section='$search_section' ";
