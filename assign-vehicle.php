                    ...
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $query = "INSERT INTO route_assigned VALUES('0','$vehicle_no','$route_name','$date_route',now() ) ";
                         ...
                         ?>
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="route_name">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Date Of Route *</label>
                                    <input type="text" placeholder="dd/mm/yyyy" name="date_route" class="form-control air-datepicker" data-position='bottom right'>
                            ...
                            <table class="table display data-table text-nowrap">
                                    ...
                                    <tr>
                                        <th> 
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label">Route No.</label>
                                            </div>
                                        </th>
                                        <th>Vehicle No.</th>
                                        <th>Route Name</th>
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $rows['date_route']; ?></td>
