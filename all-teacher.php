                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <div class="col-5-xxxl col-xl-5 col-lg-5 col-12 form-group text-right">
                                <a href="add-teacher.php" class="btn btn-primary btn-lg add-btn">+ Add New</a>
                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"><?php echo $rows['code']; ?></label>
                                            </div>
                                        </td>
                                        ...
                                        <td><?php echo $rows['Employee Status']; ?></td>
                                        <td><?php echo $rows['Marital Status']; ?></td>
                                        <td><?php echo $rows['Date Of Birth']; ?></td>
                                        <td><?php echo $rows['Aadhaar No']; ?></td>
                                        <td><?php echo $rows['Pan No']; ?></td>
                                         ...
                                         <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#"><i class="fas fa-times text-orange-red"></i>Close</a>
                                                    <a class="dropdown-item" href="#"><i class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                                    <a class="dropdown-item" href="teacher-details.php?emp_code=<?php echo $rows['code']; ?>&phone=<?php echo $rows['Phone']; ?>"><i class="fas fa-redo-alt text-orange-peel"></i>View</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>  
