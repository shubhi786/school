                    ...
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $arrival_bus_no = $_POST['arrival_bus_no'];
                                $departure_bus_no = $_POST['departure_bus_no'];


                                $query = "INSERT INTO bus_route VALUES('0','$route_no','$route_name',now() ) ";
                         ...
                         ?>
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Route No. <font color="red">*</font></label>
                                    <input type="text" placeholder="" class="form-control" name="route_no">
                                </div>
                                 <div class="col-xl-3 col-lg-6 col-12 form-group">
