                    ...
                    <form class="new-added-form" method="post">
                        <?php
                                ...
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    $q = "INSERT INTO staff_type VALUES('0','$staff_type',now() ) ";
                                    $run = $conn->query($q);
  ...
  title: 'Something went wrong'
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="staff_type">
                                </div>
