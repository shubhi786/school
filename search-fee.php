                         ...
                         ?>
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="admission_code" value="">
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <?php
                                        ...
                                        {
                                            $q = "SELECT * FROM fees WHERE session_name='$session_name' AND class='$class' AND student_roll_no='$student_roll_no' AND class_section='$section' AND student_name='$student_name' ";
