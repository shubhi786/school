                        ...
                        <div class="single-info-details mt-5">
                            ...
                            <div class="item-content">
                                <div class="header-inline item-header">
                                    <h3 class="text-dark-medium font-medium"><?php echo $rows['school_name']; ?></h3>
                                ...
                                <div class="info-table table-responsive">
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <tr>
                                                <td>School Name:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['school_name']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>School Code:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['school_code']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Address:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['address']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Phone No:</td>
                                            ...
                                            <tr>
                                                <td>Website:</td>
                                                <td class="font-medium text-dark-medium"> <a class="" style="color:green;" href="<?php echo $rows['website']; ?>"><?php echo $rows['website']; ?></a></td>
                                            </tr>
                                            <tr>
                                            <td>Student Admission No. Auto Genration:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['student_id_generation']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Staff ID Auto Genration::</td>
                                                <td class="font-medium text-dark-medium"><?php echo $rows['staff_id_generation']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>School Logo:</td>
                                                <td class="font-medium text-dark-medium"><img width="100px" height="100px" src="<?php echo $rows['school_logo']; ?>" alt="logo"></td>
                                            </tr>
                                            <tr>
                                                <td>Small Logo:</td>
                                                <td class="font-medium text-dark-medium"><img width="100px" height="100px" src="<?php echo $rows['small_logo']; ?>" alt="logo"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
