                    ...
                    <form class="new-added-form" method="post">
                        <?php
                                ...
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    $q = "INSERT INTO fee_profile VALUES('0','$profile_name','$profile_type',now() ) ";
                                    $run = $conn->query($q);
  ...
  title: 'Something went wrong'
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="profile_name">
                                </div>

                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Profile Type *</label>
                                    <select class="select2" name="profile_type" value="">
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Add Profile</button>                                    
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $rows['profile_type']; ?></td>
                                        <?php 
                                        $profile_name_rows = $rows['profile_name'];
                                        $q1 = "SELECT SUM(head_charges) AS total_confirmed FROM profiles_info WHERE profile_name='$profile_name_rows' ";
                                        ...
                                        if($sql1->num_rows > 0)
                                        {
                                            ...
                                            { 
                                                ?>
                                        <td><?php echo $rows1['total_confirmed']; ?></td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="edit_profile.php?profile_name=<?php echo $rows['profile_name']; ?>"><i class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
