                         ...
                         ?>
                            <div class="row">                                
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    ...
                                    <button class="btn-fill-lg bg-blue-dark btn-hover-yellow"><a class="text-white" href="generate-fee.php">Generate New Fee</a></button>
                                    <button class="btn-fill-lg bg-blue-dark btn-hover-yellow"><a class="text-white" href="fee-collection.php">Fee Collection</a></button>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <?php
                                    ...
                                    $session_name_create = date('Y')."-".(date('Y')+1);

                                    if(isset($student_class_get) || isset($class))
                                    {

                                    $q = "SELECT * FROM generated_fees WHERE student_class='$student_class_get' OR student_class='$class' AND session_name='$session_name_create' LIMIT 1 ";
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-weight: bold;"><?php echo $rows['student_annual_fees']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>May</td>
                                        <td><?php echo $rows['student_monthly_fees']; ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-weight: bold;font-size:25px;"><?php 
                                            echo $rows['student_annual_fees']+($rows['student_monthly_fees']*11);
                                         ?></td>
                                    </tr>
                                    <?php
                                        }
